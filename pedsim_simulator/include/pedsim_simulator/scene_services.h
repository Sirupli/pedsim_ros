...
class SceneServices {
 ...
 public:
  ...
  int last_id_polygon_;                           //Keeping track of cluster id, that increases in pedsim automatically
  ...
  ros::ServiceServer remove_all_polygons_service_;
  ros::ServiceServer spawn_ped_service_;
  ros::ServiceServer add_obstacle_service_;
  ros::ServiceServer add_polygon_service_;
  ...
  bool removeAllPolygons(std_srvs::SetBool::Request &request,
                                std_srvs::SetBool::Response &response);
  ...
  bool spawnPolygons(pedsim_srvs::SpawnZeroAgents::Request &request,
  ...
  bool addStaticObstacles(pedsim_srvs::SpawnObstacle::Request &request,
    ...
    * @return corresponding flatland model-message
    */
// std::vector<flatland_msgs::Model> addPolygonAgent(pedsim_msgs::ZeroAgent polygon);
 ...
 private:
  ...
  std::vector<std::string> removePolygonsInPedsim();
  ...
  std::vector<flatland_msgs::Model> addPolygonsToPedsim(pedsim_msgs::ZeroAgent polygon);
